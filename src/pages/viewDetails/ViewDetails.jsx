...
const ViewDetails = () => {
  ...
  return (
   <div className="max-w-6xl mx-auto p-6 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl shadow-xl text-gray-800 dark:text-gray-200">
  ...
  <div className="flex flex-col md:flex-row gap-6">
    ...
    <div className="flex-1 space-y-4">
      <h1 className="text-4xl font-bold text-orange-700 dark:text-orange-400">{decor?.title}</h1>
      <p className="text-sm text-gray-500 dark:text-gray-400">{decor?.category}</p>
      ...
      <p className="text-gray-700 dark:text-gray-300">{decor?.description}</p>
    </div>
  </div>
  ...
  <div className="mt-8">
    ...
    <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {decor?.included?.map((item, i) => (
        <li
          key={i}
          className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow text-center font-medium text-gray-800 dark:text-gray-200"
        >
          {item}
        </li>
      ))}
  ...
  {/* Price */}
  <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-4 bg-orange-100 dark:bg-orange-900 p-6 rounded-2xl">
  ...
  <dialog ref={modalRef} className="modal modal-bottom sm:modal-middle">
    <div className="modal-box bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200">
      <form onSubmit={handleSubmit(handleBooking)} className="space-y-3">
        ...
        <label className="label">Decorator Location</label>
        <input
